...
class Venue_Detail extends StatefulWidget {
  final DocumentSnapshot product;
  Venue_Detail({required this.product});

  @override
  State<Venue_Detail> createState() => _Venue_DetailState();
}

class _Venue_DetailState extends State<Venue_Detail> {
  @override
