...
class Catering_Detail extends StatefulWidget {
  final DocumentSnapshot product;
  Catering_Detail({required this.product});

  @override
  State<Catering_Detail> createState() => _Catering_DetailState();
}

class _Catering_DetailState extends State<Catering_Detail> {
  @override
